...
import { Row, Col, Tabs, Form, Button, Select, Alert, Table, Modal, Input, message, Typography, Popconfirm, Spin } from 'antd';
                                    ...
                                    <TabPane tab={`${i}`} key={i}>
                                        <Form {...layout} ref={this.formRef} name="control-ref" onFinish={this.onFinish}>
                                            ...
                                            <Form.Item {...tailLayout}>
                                                ...
                                                <Modal title="Your Order Details" visible={this.state.submit_visible} onOk={this.handleSubmit} onCancel={this.handleSubmit} footer={[]}>
                                                    <p>
                                                        Your order has been placed. Your order id is {this.state.submit_order_details[0]}. 
                                                    </p>
                                                    <p>
                                                        Kindly meet our representative at {this.state.submit_order_details[2]} during {this.state.submit_order_details[3]}. 
                                                    </p>
                                                    <p>
                                                        Total price : {this.state.submit_order_details[1]}
                                                    </p>
                                                    <p>
                                                        * Rs.3 packaging charges has been added.
                                                    </p>
                                                </Modal>
                                            </Form.Item>
                                        </Form>
